...
1. Read `docs/architecture.md`, `docs/control-plane.md`, ADR 0017, and any other relevant ADRs.
...
6. `Actor` means authenticated human/service/agent principal, never a backend worker abstraction.
