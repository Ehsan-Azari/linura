...
Release publication authority is also bounded: an exact `main` release-intent commit cannot create a tag until permanent CI, Security and CodeQL gates have succeeded for that same SHA; candidate and promotion stages operate on immutable source/tag evidence and do not rebuild during promotion.
