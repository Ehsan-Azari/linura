...
- Final reviewed v0.0.0 release authorization. [PR #13](https://github.com/linura-org/linura/pull/13). Its squash-merge SHA is the release source and is bound after merge by the exact-main gates, `RELEASE-EVIDENCE.json`, the proof receipt, and the immutable `v0.0.0` tag; it cannot be embedded in this commit without creating a self-reference cycle.
