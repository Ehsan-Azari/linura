...
- First v0.0.0 release-authorization exercise, which safely exposed a workflow-definition validation gap before any immutable tag or GitHub Release was created. [PR #11](https://github.com/linura-org/linura/pull/11)
- Release-workflow context repair and canonical GitHub Actions validation with pinned, checksum-verified `actionlint`. [PR #12](https://github.com/linura-org/linura/pull/12)
- Final reviewed v0.0.0 release authorization after release-control repair. [PR #13](https://github.com/linura-org/linura/pull/13)
